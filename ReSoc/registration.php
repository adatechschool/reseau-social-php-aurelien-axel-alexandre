...
<body>
    <div id="wrapper">
        ...
        <menu>
            <h1>Andouillettes</h1>
            <p>Bienvenue sur le réseau social de <strong>Triple A</strong></p>
        </menu>
        <main>
            <article>
                <h2>Inscription</h2>
                ...
                <form action="login.php" method="post">
                    ...
                    <dl>
                        ...
                        <dd><input type='email' name='email' placeholder="triplea@email.com" required></dd>
                        <dt><label for='motpasse'>Mot de passe</label></dt>
                        <dd><input type='password' name='motpasse' placeholder="TripleA" required></dd>
                    </dl>
